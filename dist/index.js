...
server.registerTool("set_engine", {
    ...
    description: "Toggle the speech engine. 'sapi' = built-in Windows voice (robotic, offline, free). 'elevenlabs' = natural cloud voice (needs the user's ELEVENLABS_API_KEY in the server env).",
    inputSchema: {
